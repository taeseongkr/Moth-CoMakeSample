export const audioMimeAPI = function () {
    ...
    const publicParseByAudioCodecConfig = (audioCodecConfig) => {
        let mimeType;
    ...
    const publicCreateAudioCodecConfigFromMimeObject = () => {
    ...
    return {
        parseByAudioCodecConfig: publicParseByAudioCodecConfig,
        parseMimeString: publicParseFromMimeString,
        getMime: publicGetMime,
        getMimeString: publicCreateMimeStringFromMimeObject,
        getAudioCodecConfig: publicCreateAudioCodecConfigFromMimeObject,
        isConfigured: () => {
            return isConfigured;
        },
    };
